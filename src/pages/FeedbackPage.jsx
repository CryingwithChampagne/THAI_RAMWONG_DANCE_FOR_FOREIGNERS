...
const FeedbackPage = ({ setCurrentPage, finalAverageScore, selectedPose }) => (
  <div className="w-full min-h-screen overflow-x-hidden bg-[#0B0F19] flex items-center justify-center text-white relative font-sans px-4 py-8">
    <div className="z-10 bg-[#121826] p-6 sm:p-10 lg:p-12 rounded-2xl shadow-2xl w-full max-w-2xl border border-[#D4AF37]/30 flex flex-col items-center">
      ...
      <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-full border-4 border-[#D4AF37] flex flex-col items-center justify-center bg-black/40 shadow-[0_0_40px_rgba(212,175,55,0.2)] mb-10 relative">
         ...
         <span className="text-5xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-[#D4AF37] to-[#FFDF00]">{finalAverageScore}%</span>
